...
public class ZapSpringPetclinicReview {
    public static void main(String[] args) {
        ...
        int noOfHigh = 0;
        try {
            FileReader fr = new FileReader("/var/lib/jenkins/workspace/SpringPetclinic_DevSecOps_Pipeline/JavaZapPrograms/src/ZapThreshold.txt");
        ...
        try {
            File file = new File("/var/lib/jenkins/workspace/SpringPetclinic_DevSecOps_ZapScan/reports/SPRINGPETCLINIC_ZAP_VULNERABILITY_REPORT.xml");
